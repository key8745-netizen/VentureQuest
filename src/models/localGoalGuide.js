...
const GUIDE = {
  ...
  'explore-g3': {
    reply:
      ...
      '另外，「成本加一點」是新手最常見的定價方式，也是最容易把自己鎖死的一種——' +
      '它讓你的收入上限由你剛好花了多少決定，而不是由客人得到多少決定。' +
      '客人付錢買的是他省下的時間、避開的麻煩或換到的結果，先把那個講清楚，價格才有空間。',
    steps: [
      { label: '列出事業每月固定支出（訂閱、工具、店租），填進財務面板' },
      { label: '算一次單位變動成本：材料、包材、運費、平台抽成' },
      { label: '寫下客人買這個真正換到什麼，用他的話講，不要提你的成本' },
      { label: '查 3 個同性質賣家的價格，決定你要站高、中還是低，並寫下理由' },
      { label: '確認售價減掉變動成本是正的；不是的話先調價或砍成本' },
    ],
    tasks: [{ label: '向 1 個人報出你新定的價格，記下他的反應', minutes: 15 }],
  },
  'explore-g4': {
    reply:
